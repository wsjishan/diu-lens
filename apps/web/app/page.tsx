...
export default function Home() {
  return (
    <div className="relative flex h-screen flex-col overflow-hidden bg-linear-to-br from-white via-blue-50 to-white dark:bg-linear-to-br dark:from-[#0b1220] dark:via-[#0f172a] dark:to-[#0b1220]">
