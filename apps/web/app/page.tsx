...
export default function Home() {
  return (
    <div className="relative flex min-h-screen flex-col overflow-x-hidden bg-linear-to-br from-white via-blue-50 to-white dark:bg-linear-to-br dark:from-[#0b1220] dark:via-[#0f172a] dark:to-[#0b1220] lg:h-screen lg:overflow-hidden">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-1 px-4 py-3 sm:px-6 sm:py-4 lg:px-8 lg:py-3">
        <div className="relative flex h-full min-h-0 w-full flex-1 flex-col overflow-hidden rounded-2xl border border-slate-200/90 bg-slate-50/95 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.9),0_8px_16px_-14px_rgba(15,23,42,0.24)] dark:border dark:border-white/10 dark:bg-[#0f172a] dark:shadow-[0_10px_30px_rgba(0,0,0,0.4)]">
          <div className="pointer-events-none absolute inset-0">
            <div className="ai-grid absolute inset-0 opacity-25 dark:opacity-14" />
            ...
            <div className="ai-scan-beam absolute inset-x-0 top-0 h-24 opacity-55 dark:opacity-20" />
          </div>
