...
export function HomeOnboardingSection() {
  ...
  return (
    <section className="relative w-full">
      ...
      <div className="w-full grid grid-cols-1 gap-8 px-0 pb-7 pt-3.5 md:grid-cols-[minmax(0,1fr)_minmax(0,0.95fr)] md:items-center md:gap-10 lg:grid-cols-[minmax(0,1.04fr)_minmax(0,0.96fr)] lg:gap-[4rem]">
        <div
          className={cn(
