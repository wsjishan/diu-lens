      ...
      <span
        ...
        className={cn(
          ...
          isDarkMode
            ...
            : 'left-[1.4rem] bg-blue-100/90 ring-blue-300/58 sm:left-[1.8rem]'
        )}
      />
      <span className="relative z-10 flex w-full items-center justify-between px-[0.28rem] sm:px-[0.35rem]">
        <Moon
          className={cn(
