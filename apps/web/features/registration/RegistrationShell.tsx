...
export function RegistrationShell({
  ...
  return (
    <Card
      className={cn(
        'flex w-full max-w-md flex-col rounded-2xl border border-slate-200/95 bg-white/90 p-5 shadow-[0_14px_26px_-20px_rgba(15,23,42,0.44),0_6px_12px_-10px_rgba(15,23,42,0.3),inset_0_1px_0_0_rgba(255,255,255,0.92)] backdrop-blur-sm sm:p-6 dark:border dark:border-white/10 dark:bg-[#0f172a]/95 dark:shadow-[0_10px_30px_rgba(0,0,0,0.4)]',
        className
      )}
    >
      <CardContent className="space-y-5 p-0 sm:space-y-6">
        <div className="space-y-2.5">
          ...
          <ol className="hidden gap-1.5 text-sm sm:grid sm:grid-cols-4">
