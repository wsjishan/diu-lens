  ...
  return (
    <div className="space-y-4 text-center">
      ...
      <Button
        type="button"
        onClick={onDone}
        className="h-10 rounded-lg bg-gradient-to-r from-[#1e2a78] to-[#2f5bff] px-8 text-white transition-all duration-200 ease-out hover:from-[#1a2568] hover:to-[#244ee0] dark:bg-gradient-to-r dark:from-[#1e3a8a] dark:to-[#2563eb]"
      >
        Done
      </Button>
    </div>
